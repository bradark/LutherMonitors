...
const mamaDealsWebhook = 'https://discord.com/api/webhooks/1005365559145283605/ZKCkfrZOpGgz8I9X3j91bE5s40iqe6dc91uPBvIPbpMZ_dJOY4RZbWULGNzbuirHuf5b';
...
async function writeToJsonFile(){
  fs.writeFileSync('mama_deals.json', JSON.stringify(deals));
}

async function readInDeals(){
  return new Promise((resolve, reject) => {
    fs.readFile('mama_deals.json', (err, data) => {
      if (err) throw err;
